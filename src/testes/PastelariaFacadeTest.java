...
public class PastelariaFacadeTest {
	...
	public void atualizarNomeProduto() {
		...
		Assert.assertTrue("O codigo n�o foi modificado",
	...
	public void atualizarCodigoProdutoTest() {
		...
		Assert.assertTrue("O codigo n�o foi modificado", p1.getCodigo() == "4");
	}
	...
	public void atualizarPrecoProdutoTest() {
		...
		Assert.assertTrue("O codigo n�o foi modificado", p1.getPreco() == 4.5);
	}
	...
	public void removerUmProdutoQueNaoExisteTest() {
		...
		Assert.assertFalse("O produto n�o foi removido, a assertiva deu false",
	...
	public void pesquisarUmProdutoInexistenteTest() {
		...
		// teste furado
		Assert.assertTrue("O objeto n�o deveria existir", p3 == null);
	}
	...
	public void adicionarUmClienteNoSistemaTest() {
		...
		Cliente cliente2 = fachada.pesquisarClienteNoSistema(cliente
				.getTelefone());
		Assert.assertTrue("N�mero de telefone inesperado",
